...
public class WorkFeignClientApi implements WorkFeignClient {
    ...
    @Override
    @TeoanLog(operSource = "work", operName = "查询", severity = LogSeverity.INFO, description = "分页查询所有作业数据")
    ...
    @Override
    @TeoanLog(operSource = "work", operName = "查询", severity = LogSeverity.INFO, description = "获取拓展名列表")
    public R getExtensionList() {
        return R.ok(extensionService.list());
    }

    @Override
    @TeoanLog(operSource = "work", operName = "添加", severity = LogSeverity.INFO, description = "学生上传作业")
    ...
    @Override
    @TeoanLog(operSource = "work", operName = "查询", severity = LogSeverity.INFO, description = "检查用户是否已上传文件")
    public R isUploadedWorkFile(Integer wId, Integer sId) {
        return R.ok(uploadService.isUploadedWorkFile(wId,sId));
    }

    @Override
    @TeoanLog(operSource = "work", operName = "删除", severity = LogSeverity.INFO, description = "删除已上传的文件")
    ...
    @Override
    @TeoanLog(operSource = "work", operName = "查询", severity = LogSeverity.INFO, description = "通过主键查询单条数据")
    public R selectOne(Serializable id) {
        return R.ok(workService.getById(id));
    }

    @Override
    @TeoanLog(operSource = "work", operName = "新增", severity = LogSeverity.INFO, description = "新增数据")
    ...
    @Override
    @TeoanLog(operSource = "work", operName = "修改", severity = LogSeverity.INFO, description = "修改数据")
    ...
    @Override
    @TeoanLog(operSource = "work", operName = "删除", severity = LogSeverity.INFO, description = "根据id列表删除数据")
    ...
    public void downloadWorkFile(String fileName, Integer wId, HttpServletResponse response) {
        byte[] fileByte = workService.getFile(wId, fileName);
    ...
    public void downloadZipWorkFile(Integer wId,HttpServletResponse response) {
        ...
        File file = workService.getZipByWId(wId);
    ...
    @Override
    @TeoanLog(operSource = "work", operName = "查询", severity = LogSeverity.INFO, description = "获取上传文件信息并分页")
    ...
    @Override
    @TeoanLog(operSource = "work", operName = "删除", severity = LogSeverity.INFO, description = "根据上传文件信息列表批量删除文件")
    ...
    @Override
    @TeoanLog(operSource = "work", operName = "删除", severity = LogSeverity.INFO, description = "根据id删除扩展名")
    public R deleteExtensionById(ExtensionDTO extensionDTO) {
        return R.ok(extensionService.removeById(extensionDTO.getId()));
    }

    @Override
    @TeoanLog(operSource = "work", operName = "新增", severity = LogSeverity.INFO, description = "添加扩展名")
