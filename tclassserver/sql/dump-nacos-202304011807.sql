...
VALUES (8, 'tclass-gateway', 'DEFAULT_GROUP',
        ...
        '', '', '', 'yaml', '', ''),
       (10, 'tclass-oauth-server', 'DEFAULT_GROUP',
        ...
        '8304b57aff16bb4be993cb3deefa386e', '2023-04-01 03:33:17', '2023-04-01 03:41:56', 'nacos', '172.28.0.1', '', '',
        '', '', '', 'yaml', '', ''),
       (15, 'tclass-notice-server', 'DEFAULT_GROUP',
        ...
        '806d2e2846b5f47f235c657ed2a49209', '2023-04-01 04:20:09', '2023-04-01 04:36:23', 'nacos', '172.28.0.1', '', '',
        '', '', '', 'yaml', '', ''),
       (19, 'tclass-user-server', 'DEFAULT_GROUP',
        ...
        'c804f00626efbf32e6ed9ab7c070f1d6', '2023-04-01 04:42:56', '2023-04-01 04:44:20', 'nacos', '172.28.0.1', '', '',
        '', '', '', 'yaml', '', ''),
       (21, 'tclass-work-server', 'DEFAULT_GROUP',
        'server:\n  port: 8004\n  servlet:\n    context-path: \"/work\"\nspring:\n  datasource: #数据库连接配置\n    type: com.alibaba.druid.pool.DruidDataSource\n    username: root\n    password: teoan_pwd+-\n    url: jdbc:mysql://mysql:3306/tclass?useUnicode=true&characterEncoding=UTF-8&serverTimezone=Asia/Shanghai\n    druid:\n      stat-view-servlet:\n        login-username: Teoan\n        login-password: 277077411\n  redis:\n    host: mysql\n    database: 0\n    port: 6379\n    # password: 277077411\n  jackson:\n    date-format: yyyy-MM-dd HH:mm:ss\n    time-zone: GMT+8\n  #配置文件上传大小\n  servlet:\n    multipart:\n      max-request-size: 30MB\n      max-file-size: 50MB\n  #将前端传来的String解析为Data\n  mvc:\n    format:\n      date: yyyy-MM-dd HH:mm:ss\nmybatis-plus:\n  global-config:\n    banner: false\nfeign:\n  hystrix:\n    enabled: true\n  compression:\n    request:\n      #是否启用请求GZIP压缩，true：启用，false：不启用\n      enabled: true\n      #压缩支持的MIME TYPE\n      mime-types: text/xml,application/xml,application/json\n      #压缩数据的最小值\n      min-request-size: 2048\n    response:\n      #是否启用响应GZIP压缩，true：启用，false：不启用\n      enabled: true\n  client:\n    config:\n      #feign全局配置\n      default:\n        #指定日志级别，none：不记录任何日志，basic：仅记录请求方法、URL、响应状态代码以及执行时间（适合生产环境）\n        #headers：在basic基础上，记录请求和响应的header，full：记录请求和响应的header、body和元数据，默认none\n        loggerLevel: headers\n      #feign指定客户端配置，即仅对指定调用的服务生效\n      eureka-client:\n        loggerLevel: full\nhystrix:\n  command:\n    default:\n      execution:\n        timeout:\n          enabled: true\n        isolation:\n          strategy: SEMAPHORE\n#fastdfs 配置\nfdfs:\n  # 读取时间\n  so-timeout: 1500\n  # 连接超时时间\n  connect-timeout: 600\n  # 缩略图\n  thumb-image:\n    width: 150\n    height: 150\n  # Tracker服务\n  tracker-list:\n    - qexw.xumumi.com:22122\noauth2:\n  resource:\n    permit-all-paths:  #配置认证放行路径',
        '28e8f1fdee269cde6f973c2f5988cbc5', '2023-04-01 04:49:51', '2023-04-01 04:52:36', 'nacos', '172.28.0.1', '', '',
        '', '', '', 'yaml', '', '');
/*!40000 ALTER TABLE `config_info`
  ENABLE KEYS */;
UNLOCK TABLES;
...
VALUES (0, 1, 'test', 'DEFAULT_GROUP', '', 'asdad', '056f32ee5cf49404607e368bd8d3f2af', '2023-03-31 17:17:05',
        '2023-03-31 17:17:05', NULL, '172.22.0.1', 'I', '', ''),
       (1, 2, 'test', 'DEFAULT_GROUP', '', 'asdad', '056f32ee5cf49404607e368bd8d3f2af', '2023-03-31 17:17:33',
        '2023-03-31 17:17:34', NULL, '172.22.0.1', 'D', '', ''),
       (0, 3, 'tclass-gateway', 'DEFAULT_GROUP', '',
        'server:\n  port: @server.port@\nspring:\n  application:\n    name: tclass-gateway #指定应用的唯一标识/服务名\n  main:\n    allow-bean-definition-overriding: true',
        '73a766e7bea008965967f335f438b363', '2023-03-31 18:21:47', '2023-03-31 18:21:47', NULL, '172.22.0.1', 'I', '',
        ''),
       (2, 4, 'tclass-gateway', 'DEFAULT_GROUP', '',
        'server:\n  port: @server.port@\nspring:\n  application:\n    name: tclass-gateway #指定应用的唯一标识/服务名\n  main:\n    allow-bean-definition-overriding: true',
        '73a766e7bea008965967f335f438b363', '2023-03-31 18:32:33', '2023-03-31 18:32:00', 'nacos', '172.22.0.1', 'U',
        '', ''),
       (0, 5, 'tclass-gateway.yaml', 'DEFAULT_GROUP', '',
        'server:\n  port: 9999\nspring:\n  application:\n    name: tclass-gateway #指定应用的唯一标识/服务名\n  main:\n    allow-bean-definition-overriding: true',
        '622cd1701bf57904bc07843563e36890', '2023-04-01 15:41:12', '2023-04-01 02:41:12', NULL, '0:0:0:0:0:0:0:1', 'I',
        '', ''),
       (2, 6, 'tclass-gateway', 'DEFAULT_GROUP', '',
        'server:\n  port: 9999\nspring:\n  application:\n    name: tclass-gateway #指定应用的唯一标识/服务名\n  main:\n    allow-bean-definition-overriding: true',
        '622cd1701bf57904bc07843563e36890', '2023-04-01 15:41:20', '2023-04-01 02:41:20', NULL, '0:0:0:0:0:0:0:1', 'D',
        '', ''),
       (0, 7, 'tclass-gateway', 'DEFAULT_GROUP', '',
        'server:\n  port: 9999\nspring:\n  application:\n    name: tclass-gateway #指定应用的唯一标识/服务名\n  main:\n    allow-bean-definition-overriding: true',
        '622cd1701bf57904bc07843563e36890', '2023-04-01 15:43:28', '2023-04-01 02:43:29', NULL, '0:0:0:0:0:0:0:1', 'I',
        '', ''),
       (4, 8, 'tclass-gateway.yaml', 'DEFAULT_GROUP', '',
        'server:\n  port: 9999\nspring:\n  application:\n    name: tclass-gateway #指定应用的唯一标识/服务名\n  main:\n    allow-bean-definition-overriding: true',
        '622cd1701bf57904bc07843563e36890', '2023-04-01 15:48:17', '2023-04-01 02:48:18', NULL, '0:0:0:0:0:0:0:1', 'D',
        '', ''),
       (5, 9, 'tclass-gateway', 'DEFAULT_GROUP', '',
        'server:\n  port: 9999\nspring:\n  application:\n    name: tclass-gateway #指定应用的唯一标识/服务名\n  main:\n    allow-bean-definition-overriding: true',
        '622cd1701bf57904bc07843563e36890', '2023-04-01 15:48:24', '2023-04-01 02:48:24', 'nacos', '0:0:0:0:0:0:0:1',
        'U', '', ''),
       (0, 10, 'tclass-gateway.yaml', 'DEFAULT_GROUP', '',
        'server:\n  port: 9999\nspring:\n  application:\n    name: tclass-gateway #指定应用的唯一标识/服务名\n  main:\n    allow-bean-definition-overriding: true',
        '622cd1701bf57904bc07843563e36890', '2023-04-01 15:57:22', '2023-04-01 02:57:22', NULL, '172.28.0.1', 'I', '',
        ''),
       (5, 11, 'tclass-gateway', 'DEFAULT_GROUP', '',
        'server:\n  port: 9999\nspring:\n  application:\n    name: tclass-gateway #指定应用的唯一标识/服务名\n  main:\n    allow-bean-definition-overriding: true',
        '622cd1701bf57904bc07843563e36890', '2023-04-01 15:57:28', '2023-04-01 02:57:29', NULL, '172.28.0.1', 'D', '',
        ''),
       (0, 12, 'tclass-gateway', 'DEFAULT_GROUP', '',
        'server:\n  port: 9999\nspring:\n  application:\n    name: tclass-gateway #指定应用的唯一标识/服务名\n  main:\n    allow-bean-definition-overriding: true',
        '622cd1701bf57904bc07843563e36890', '2023-04-01 15:58:25', '2023-04-01 02:58:25', NULL, '172.28.0.1', 'I', '',
        ''),
       (7, 13, 'tclass-gateway.yaml', 'DEFAULT_GROUP', '',
        'server:\n  port: 9999\nspring:\n  application:\n    name: tclass-gateway #指定应用的唯一标识/服务名\n  main:\n    allow-bean-definition-overriding: true',
        '622cd1701bf57904bc07843563e36890', '2023-04-01 15:58:29', '2023-04-01 02:58:29', NULL, '172.28.0.1', 'D', '',
        ''),
       (8, 14, 'tclass-gateway', 'DEFAULT_GROUP', '',
        'server:\n  port: 9999\nspring:\n  application:\n    name: tclass-gateway #指定应用的唯一标识/服务名\n  main:\n    allow-bean-definition-overriding: true',
        '622cd1701bf57904bc07843563e36890', '2023-04-01 16:32:33', '2023-04-01 03:32:33', 'nacos', '172.28.0.1', 'U',
        '', ''),
       (0, 15, 'tclass-oauth-server', 'DEFAULT_GROUP', '',
        'server:\n  port: 6666\nspring:\n  application:\n    name: tclass-gateway #指定应用的唯一标识/服务名\n  main:\n    allow-bean-definition-overriding: true',
        '9c0053701eb485a39b73706166378917', '2023-04-01 16:33:17', '2023-04-01 03:33:17', NULL, '172.28.0.1', 'I', '',
        ''),
       (10, 16, 'tclass-oauth-server', 'DEFAULT_GROUP', '',
        'server:\n  port: 6666\nspring:\n  application:\n    name: tclass-gateway #指定应用的唯一标识/服务名\n  main:\n    allow-bean-definition-overriding: true',
        '9c0053701eb485a39b73706166378917', '2023-04-01 16:33:28', '2023-04-01 03:33:29', 'nacos', '172.28.0.1', 'U',
        '', ''),
       (10, 17, 'tclass-oauth-server', 'DEFAULT_GROUP', '',
        'server:\n  port: 9999\nspring:\n  application:\n    name: tclass-gateway #指定应用的唯一标识/服务名\n  main:\n    allow-bean-definition-overriding: true',
        '622cd1701bf57904bc07843563e36890', '2023-04-01 16:33:37', '2023-04-01 03:33:38', 'nacos', '172.28.0.1', 'U',
        '', ''),
       (8, 18, 'tclass-gateway', 'DEFAULT_GROUP', '',
        'server:\n  port: 6666\nspring:\n  application:\n    name: tclass-gateway #指定应用的唯一标识/服务名\n  main:\n    allow-bean-definition-overriding: true',
        '9c0053701eb485a39b73706166378917', '2023-04-01 16:38:58', '2023-04-01 03:38:58', 'nacos', '172.28.0.1', 'U',
        '', ''),
       (10, 19, 'tclass-oauth-server', 'DEFAULT_GROUP', '',
        'server:\n  port: 9999\nspring:\n  application:\n    name: tclass-oauth-server #指定应用的唯一标识/服务名\n  main:\n    allow-bean-definition-overriding: true',
        '8c7f3633a5516447d8c2283c19b85348', '2023-04-01 16:41:56', '2023-04-01 03:41:56', 'nacos', '172.28.0.1', 'U',
        '', ''),
       (0, 20, 'tclass-notice-server', 'DEFAULT_GROUP', '',
        'server:\n  port: 9999\nspring:\n  application:\n    name: tclass-oauth-server #指定应用的唯一标识/服务名\n  main:\n    allow-bean-definition-overriding: true\n  datasource: #数据库连接配置\n    type: com.alibaba.druid.pool.DruidDataSource\n    username: root\n    password: teoan_pwd+-\n    url: jdbc:mysql://mysql:3306/tclass?useUnicode=true&characterEncoding=UTF-8&serverTimezone=Asia/Shanghai\n    druid:\n      stat-view-servlet:\n        login-username: Teoan\n        login-password: 277077411\n  redis:\n    host: redis\n    database: 0\n    port: 6379\n    password: \nmybatis-plus:\n  global-config:\n    banner: false\n\noauth2:\n  resource:\n    permit-all-paths: /oauth/login,/oauth/verifyCode.jpg #配置认证放行路径',
        '8304b57aff16bb4be993cb3deefa386e', '2023-04-01 17:20:09', '2023-04-01 04:20:09', NULL, '172.28.0.1', 'I', '',
        ''),
       (15, 21, 'tclass-notice-server', 'DEFAULT_GROUP', '',
        'server:\n  port: 9999\nspring:\n  application:\n    name: tclass-oauth-server #指定应用的唯一标识/服务名\n  main:\n    allow-bean-definition-overriding: true\n  datasource: #数据库连接配置\n    type: com.alibaba.druid.pool.DruidDataSource\n    username: root\n    password: teoan_pwd+-\n    url: jdbc:mysql://mysql:3306/tclass?useUnicode=true&characterEncoding=UTF-8&serverTimezone=Asia/Shanghai\n    druid:\n      stat-view-servlet:\n        login-username: Teoan\n        login-password: 277077411\n  redis:\n    host: redis\n    database: 0\n    port: 6379\n    password: \nmybatis-plus:\n  global-config:\n    banner: false\n\noauth2:\n  resource:\n    permit-all-paths: /oauth/login,/oauth/verifyCode.jpg #配置认证放行路径',
        '8304b57aff16bb4be993cb3deefa386e', '2023-04-01 17:23:25', '2023-04-01 04:23:26', 'nacos', '172.28.0.1', 'U',
        '', ''),
       (15, 22, 'tclass-notice-server', 'DEFAULT_GROUP', '',
        'server:\n  port: 8002\n  servlet:\n    context-path: \"/notice\"\nspring:\n  datasource: #数据库连接配置\n    type: com.alibaba.druid.pool.DruidDataSource\n    username: root\n    password: teoan_pwd+-\n    url: jdbc:mysql://mysql:3306/tclass?useUnicode=true&characterEncoding=UTF-8&serverTimezone=Asia/Shanghai\n    druid:\n      stat-view-servlet:\n        login-username: Teoan\n        login-password: 277077411\n  redis:\n    host: redis\n    database: 0\n    port: 6379\n    password: \n  jackson:\n    date-format: yyyy-MM-dd HH:mm:ss\n    time-zone: GMT+8\n  #配置文件上传大小\n  servlet:\n    multipart:\n      max-request-size: 30MB\n      max-file-size: 50MB\n  #将前端传来的String解析为Data\n  mvc:\n    format:\n      date: yyyy-MM-dd HH:mm:ss\n# 注册中心配置\neureka:\n  instance:\n    prefer-ip-address: true #优先使用IP地址注册\n  client:\n    service-url:\n      defaultZone: http://teoan:277077411@localhost:8761/eureka/ #eureka的注册地址\nfeign:\n  hystrix:\n    enabled: true\n  compression:\n    request:\n      #是否启用请求GZIP压缩，true：启用，false：不启用\n      enabled: true\n      #压缩支持的MIME TYPE\n      mime-types: text/xml,application/xml,application/json\n      #压缩数据的最小值\n      min-request-size: 2048\n    response:\n      #是否启用响应GZIP压缩，true：启用，false：不启用\n      enabled: true\nhystrix:\n  command:\n    default:\n      execution:\n        timeout:\n          enabled: true\n        isolation:\n          strategy: SEMAPHORE\nmybatis-plus:\n  global-config:\n    banner: false',
        '2fea0fd5c4ccfb0c4fa8643196c24477', '2023-04-01 17:35:07', '2023-04-01 04:35:07', 'nacos', '172.28.0.1', 'U',
        '', ''),
       (15, 23, 'tclass-notice-server', 'DEFAULT_GROUP', '',
        'server:\n  port: 8002\n  servlet:\n    context-path: \"/notice\"\nspring:\n  datasource: #数据库连接配置\n    type: com.alibaba.druid.pool.DruidDataSource\n    username: root\n    password: teoan_pwd+-\n    url: jdbc:mysql://mysql:3306/tclass?useUnicode=true&characterEncoding=UTF-8&serverTimezone=Asia/Shanghai\n    druid:\n      stat-view-servlet:\n        login-username: Teoan\n        login-password: 277077411\n  redis:\n    host: redis\n    database: 0\n    port: 6379\n    password: \n  jackson:\n    date-format: yyyy-MM-dd HH:mm:ss\n    time-zone: GMT+8\n  #配置文件上传大小\n  servlet:\n    multipart:\n      max-request-size: 30MB\n      max-file-size: 50MB\n  #将前端传来的String解析为Data\n  mvc:\n    format:\n      date: yyyy-MM-dd HH:mm:ss\n# 注册中心配置\neureka:\n  instance:\n    prefer-ip-address: true #优先使用IP地址注册\n  client:\n    service-url:\n      defaultZone: http://teoan:277077411@localhost:8761/eureka/ #eureka的注册地址\nfeign:\n  hystrix:\n    enabled: true\n  compression:\n    request:\n      #是否启用请求GZIP压缩，true：启用，false：不启用\n      enabled: true\n      #压缩支持的MIME TYPE\n      mime-types: text/xml,application/xml,application/json\n      #压缩数据的最小值\n      min-request-size: 2048\n    response:\n      #是否启用响应GZIP压缩，true：启用，false：不启用\n      enabled: true\nhystrix:\n  command:\n    default:\n      execution:\n        timeout:\n          enabled: true\n        isolation:\n          strategy: SEMAPHORE\nmybatis-plus:\n  global-config:\n    banner: false',
        '2fea0fd5c4ccfb0c4fa8643196c24477', '2023-04-01 17:36:23', '2023-04-01 04:36:23', 'nacos', '172.28.0.1', 'U',
        '', ''),
       (0, 24, 'tclass-user-server', 'DEFAULT_GROUP', '',
        'server:\n  port: 8002\n  servlet:\n    context-path: \"/notice\"\nspring:\n  datasource: #数据库连接配置\n    type: com.alibaba.druid.pool.DruidDataSource\n    username: root\n    password: teoan_pwd+-\n    url: jdbc:mysql://mysql:3306/tclass?characterEncoding=utf8&connectTimeout=1000&socketTimeout=3000&autoReconnect=true&useSSL=false&allowPublicKeyRetrieval=true\n    druid:\n      stat-view-servlet:\n        login-username: Teoan\n        login-password: 277077411\n  redis:\n    host: redis\n    database: 0\n    port: 6379\n    password: \n  jackson:\n    date-format: yyyy-MM-dd HH:mm:ss\n    time-zone: GMT+8\n  #配置文件上传大小\n  servlet:\n    multipart:\n      max-request-size: 30MB\n      max-file-size: 50MB\n  #将前端传来的String解析为Data\n  mvc:\n    format:\n      date: yyyy-MM-dd HH:mm:ss\n# 注册中心配置\neureka:\n  instance:\n    prefer-ip-address: true #优先使用IP地址注册\n  client:\n    service-url:\n      defaultZone: http://teoan:277077411@localhost:8761/eureka/ #eureka的注册地址\nfeign:\n  hystrix:\n    enabled: true\n  compression:\n    request:\n      #是否启用请求GZIP压缩，true：启用，false：不启用\n      enabled: true\n      #压缩支持的MIME TYPE\n      mime-types: text/xml,application/xml,application/json\n      #压缩数据的最小值\n      min-request-size: 2048\n    response:\n      #是否启用响应GZIP压缩，true：启用，false：不启用\n      enabled: true\nhystrix:\n  command:\n    default:\n      execution:\n        timeout:\n          enabled: true\n        isolation:\n          strategy: SEMAPHORE\nmybatis-plus:\n  global-config:\n    banner: false',
        '806d2e2846b5f47f235c657ed2a49209', '2023-04-01 17:42:56', '2023-04-01 04:42:56', NULL, '172.28.0.1', 'I', '',
        ''),
       (19, 25, 'tclass-user-server', 'DEFAULT_GROUP', '',
        'server:\n  port: 8002\n  servlet:\n    context-path: \"/notice\"\nspring:\n  datasource: #数据库连接配置\n    type: com.alibaba.druid.pool.DruidDataSource\n    username: root\n    password: teoan_pwd+-\n    url: jdbc:mysql://mysql:3306/tclass?characterEncoding=utf8&connectTimeout=1000&socketTimeout=3000&autoReconnect=true&useSSL=false&allowPublicKeyRetrieval=true\n    druid:\n      stat-view-servlet:\n        login-username: Teoan\n        login-password: 277077411\n  redis:\n    host: redis\n    database: 0\n    port: 6379\n    password: \n  jackson:\n    date-format: yyyy-MM-dd HH:mm:ss\n    time-zone: GMT+8\n  #配置文件上传大小\n  servlet:\n    multipart:\n      max-request-size: 30MB\n      max-file-size: 50MB\n  #将前端传来的String解析为Data\n  mvc:\n    format:\n      date: yyyy-MM-dd HH:mm:ss\n# 注册中心配置\neureka:\n  instance:\n    prefer-ip-address: true #优先使用IP地址注册\n  client:\n    service-url:\n      defaultZone: http://teoan:277077411@localhost:8761/eureka/ #eureka的注册地址\nfeign:\n  hystrix:\n    enabled: true\n  compression:\n    request:\n      #是否启用请求GZIP压缩，true：启用，false：不启用\n      enabled: true\n      #压缩支持的MIME TYPE\n      mime-types: text/xml,application/xml,application/json\n      #压缩数据的最小值\n      min-request-size: 2048\n    response:\n      #是否启用响应GZIP压缩，true：启用，false：不启用\n      enabled: true\nhystrix:\n  command:\n    default:\n      execution:\n        timeout:\n          enabled: true\n        isolation:\n          strategy: SEMAPHORE\nmybatis-plus:\n  global-config:\n    banner: false',
        '806d2e2846b5f47f235c657ed2a49209', '2023-04-01 17:44:20', '2023-04-01 04:44:20', 'nacos', '172.28.0.1', 'U',
        '', ''),
       (0, 26, 'tclass-work-server', 'DEFAULT_GROUP', '',
        'server:\n  port: 8003\n  servlet:\n    context-path: \"/user\"\nspring:\n  datasource: #数据库连接配置\n    type: com.alibaba.druid.pool.DruidDataSource\n    username: root\n    password: teoan_pwd+-\n    url: jdbc:mysql://mysql:3306/tclass?useUnicode=true&characterEncoding=UTF-8&serverTimezone=Asia/Shanghai\n    druid:\n      stat-view-servlet:\n        login-username: Teoan\n        login-password: 277077411\n  redis:\n    host: localhost\n    database: 0\n    port: 6379\n  jackson:\n    date-format: yyyy-MM-dd HH:mm:ss\n    time-zone: GMT+8\n  #配置文件上传大小\n  servlet:\n    multipart:\n      max-request-size: 30MB\n      max-file-size: 50MB\n  #将前端传来的String解析为Data\n  mvc:\n    format:\n      date: yyyy-MM-dd HH:mm:ss\n# 注册中心配置\neureka:\n  instance:\n    prefer-ip-address: true #优先使用IP地址注册\n  client:\n    service-url:\n      defaultZone: http://teoan:277077411@localhost:8761/eureka/ #eureka的注册地址\nmybatis-plus:\n  global-config:\n    banner: false\nfeign:\n  hystrix:\n    enabled: true\n  compression:\n    request:\n      #是否启用请求GZIP压缩，true：启用，false：不启用\n      enabled: true\n      #压缩支持的MIME TYPE\n      mime-types: text/xml,application/xml,application/json\n      #压缩数据的最小值\n      min-request-size: 2048\n    response:\n      #是否启用响应GZIP压缩，true：启用，false：不启用\n      enabled: true\n  client:\n    config:\n      #feign全局配置\n      default:\n        #指定日志级别，none：不记录任何日志，basic：仅记录请求方法、URL、响应状态代码以及执行时间（适合生产环境）\n        #headers：在basic基础上，记录请求和响应的header，full：记录请求和响应的header、body和元数据，默认none\n        loggerLevel: headers\n      #feign指定客户端配置，即仅对指定调用的服务生效\n      eureka-client:\n        loggerLevel: full\nhystrix:\n  command:\n    default:\n      execution:\n        timeout:\n          enabled: true\n        isolation:\n          strategy: SEMAPHORE\n#fastdfs 配置\nfdfs:\n  # 读取时间\n  so-timeout: 1500\n  # 连接超时时间\n  connect-timeout: 600\n  # 缩略图\n  thumb-image:\n    width: 150\n    height: 150\n  # Tracker服务\n  tracker-list:\n    - www.xumumi.com:22122\noauth2:\n  resource:\n    permit-all-paths: /avatar/get/**,/admin/template #配置认证放行路径',
        'c804f00626efbf32e6ed9ab7c070f1d6', '2023-04-01 17:49:50', '2023-04-01 04:49:51', NULL, '172.28.0.1', 'I', '',
        ''),
       (21, 27, 'tclass-work-server', 'DEFAULT_GROUP', '',
        'server:\n  port: 8003\n  servlet:\n    context-path: \"/user\"\nspring:\n  datasource: #数据库连接配置\n    type: com.alibaba.druid.pool.DruidDataSource\n    username: root\n    password: teoan_pwd+-\n    url: jdbc:mysql://mysql:3306/tclass?useUnicode=true&characterEncoding=UTF-8&serverTimezone=Asia/Shanghai\n    druid:\n      stat-view-servlet:\n        login-username: Teoan\n        login-password: 277077411\n  redis:\n    host: localhost\n    database: 0\n    port: 6379\n  jackson:\n    date-format: yyyy-MM-dd HH:mm:ss\n    time-zone: GMT+8\n  #配置文件上传大小\n  servlet:\n    multipart:\n      max-request-size: 30MB\n      max-file-size: 50MB\n  #将前端传来的String解析为Data\n  mvc:\n    format:\n      date: yyyy-MM-dd HH:mm:ss\n# 注册中心配置\neureka:\n  instance:\n    prefer-ip-address: true #优先使用IP地址注册\n  client:\n    service-url:\n      defaultZone: http://teoan:277077411@localhost:8761/eureka/ #eureka的注册地址\nmybatis-plus:\n  global-config:\n    banner: false\nfeign:\n  hystrix:\n    enabled: true\n  compression:\n    request:\n      #是否启用请求GZIP压缩，true：启用，false：不启用\n      enabled: true\n      #压缩支持的MIME TYPE\n      mime-types: text/xml,application/xml,application/json\n      #压缩数据的最小值\n      min-request-size: 2048\n    response:\n      #是否启用响应GZIP压缩，true：启用，false：不启用\n      enabled: true\n  client:\n    config:\n      #feign全局配置\n      default:\n        #指定日志级别，none：不记录任何日志，basic：仅记录请求方法、URL、响应状态代码以及执行时间（适合生产环境）\n        #headers：在basic基础上，记录请求和响应的header，full：记录请求和响应的header、body和元数据，默认none\n        loggerLevel: headers\n      #feign指定客户端配置，即仅对指定调用的服务生效\n      eureka-client:\n        loggerLevel: full\nhystrix:\n  command:\n    default:\n      execution:\n        timeout:\n          enabled: true\n        isolation:\n          strategy: SEMAPHORE\n#fastdfs 配置\nfdfs:\n  # 读取时间\n  so-timeout: 1500\n  # 连接超时时间\n  connect-timeout: 600\n  # 缩略图\n  thumb-image:\n    width: 150\n    height: 150\n  # Tracker服务\n  tracker-list:\n    - www.xumumi.com:22122\noauth2:\n  resource:\n    permit-all-paths: /avatar/get/**,/admin/template #配置认证放行路径',
        'c804f00626efbf32e6ed9ab7c070f1d6', '2023-04-01 17:52:35', '2023-04-01 04:52:36', 'nacos', '172.28.0.1', 'U',
        '', '');
/*!40000 ALTER TABLE `his_config_info`
  ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2023-04-01 18:07:13
